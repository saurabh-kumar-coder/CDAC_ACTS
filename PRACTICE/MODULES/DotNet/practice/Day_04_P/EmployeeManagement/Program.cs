namespace n1
{
    ...
    public abstract class Employee : IDbFunctions
    {
        ...
        public String Name
        {
            ...
            set
            {
                this.name = value == "" ? throw new InvalidNameException("Invalid Name") : value;
            }
        }
        ...
        public short DeptNo
        {
            ...
            set
            {
                this.deptNo = (short)(value == 0 ? throw new InvalidDeptNoException("Invalid Dept no : " + deptNo) : value);
            }
        }
        // abstract property
    ...
    public class Manager : Employee
    {
        ...
        public override decimal Basic
        {
            ...
            set
            {
                this.basic = value == 0.0M ? throw new InvalidBasicException("Invalid Basic : " + basic) : value;
            }
        }
        ...
        public String Designation
        {
            ...
            set
            {
                this.designation = value == "" || value == null ? throw new InvalidDesignationException("Designation Can't Be NULL") : value;
            }
        }
        // ctor
    ...
    public class GeneralManager : Manager
    {
        ...
        // ctor
        public GeneralManager(String perks = "null", String designation = "Associate", decimal basic = 1000, String name = "ABC", short deptNo = 1) : base(designation, basic, name, deptNo)
        {
            this.Perks = perks;
        }
        // ToString
    ...
    public class Tester
    {
        public static void Main()
        {
            ...
            try
            {
                employee = new Manager("Manager", 30000, "Saurabh", 5);
